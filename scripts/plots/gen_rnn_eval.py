...
from hyper_lrrnn.gen.mmd import compute_rbf_mmd, median_heuristic
...
bandwidth = 0.25
mmd_baseline = []
print(median_heuristic(params[:len(params) // 2], params[len(params) // 2:]))
...
with matplotlib.rc_context(fname=rc_path):
    ...
    plt.tight_layout()
    plt.savefig(f'acc_by_model.png')
